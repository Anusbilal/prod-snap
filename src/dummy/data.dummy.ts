...
export const FEATURES_DATA = [
  { title: 'Templates For Every Category', content: 'Details of Feature 1', image: User1 },
  { title: 'Remove Backgrounds With AI', content: 'Details of Feature 2', image: FeatureImage },
  {
  ...
  { title: 'Add Shapes, Graphics And Backgrounds', content: 'Details of Feature 3', image: FeatureImage },
  { title: '1000s Of Different Fonts', content: 'Details of Feature 3', image: FeatureImage },
  { title: 'Millions Of Photos & Graphics', content: 'Details of Feature 3', image: User3 },
]
...
export const TESTIMONIAL_DATA = [
  ...
  },
  {
    ...
    review: 'As a small business, this has been a game-changer. My products now look as good as big brand listings.',
    image:
...
export const HOW_IT_WORK_DATA = [
  ...
  },
  {
    ...
    description: 'Adjust colors, shadows, angles, and more using our simple editor. Stay on-brand without a designer.',
    src: HowItWorkImage3,
  ...
  },
  {
    ...
    description: 'Download high-quality images ready for your store, ads, or socials — in minutes, not days.',
    src: HowItWorkImage4,
    textColor: 'text-[#D1ECFD]',
  },
]

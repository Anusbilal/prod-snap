...
import { FeaturesBgShade, FeaturesBgShadeSmall, LoadingIcon } from '~/assets/svg'
import {
...
export function HowItWorksSection() {
  ...
  return (
    <div ref={sectionRef} style={{ height: `${(totalCards + 1) * 100}vh` }} className="relative w-full bg-white">
      <div
      ...
      >
        <div className="flex flex-col gap-4 lg:gap-6 justify-center items-center mb-[56px] z-10">
          <IconButton title="How it works" src={LoadingIcon} className="mb-2 bg-lightblue" />

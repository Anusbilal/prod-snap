...
import { HeroSectionBgShade, HeroSectionBgShadeSmall, StarsIcon } from '~/assets/svg'
...
export function HeroSection() {
  ...
  return (
    <section className="pt-[37.5px] lg:pt-[65.5px] px-4 lg:px-[42px] xl:px-[82px] grid lg:grid-cols-2 gap-[58.5px] lg:gap-[45px] ">
      <div className="lg:gap-8 gap-6 flex flex-col lg:mb-[150px]">
        <IconButton src={StarsIcon} title="Turn products into bestsellers — visually" />
        ...
        <div className="flex flex-col gap-4  lg:gap-6 lg:max-w-[750px]">
          ...
          <p className="font-normal text-sm lg:text-base font-Poppins  text-black600">
            Create stunning product photos for your e-commerce store in minutes. Use our easy template editor to create
            professional visuals – it's like Canva, but built for product photos!
          </p>
        </div>

        <div className="flex items-center gap-6 mt-4">
          <TextButton title="Join Waitlist" />
          <TextButton title="Learn More" className="bg-white hover:bg-white/60 text-black900" />
        </div>
